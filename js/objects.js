...
// Lab 3
function Hamburger(bun, vegetables, cheese, sauce, meat, pattyCount, extras) {
    this.bun = bun;
    ...
    this.myFunc = function() {
         return `Your Hamburger includes: ${this.bun} with ${this.vegetables} and cheese is ${this.cheese} with ${this.sauce} and ${this.pattyCount} ${this.meat} and also includes ${this.extras} as extras.\nNOTE: Extras are charged extra.\nEnjoy Your Meal!`;
    };
}
...
output1.textContent = myHamburger.myFunc();
